...
static NSString *const cellId = @"THNCuXiaoCollectionViewCell";

@implementation THNSalesViewController
...
-(UICollectionView *)contenView{
    if (!_contenView) {
        ...
        [_contenView registerNib:[UINib nibWithNibName:@"THNCuXiaoCollectionViewCell" bundle:nil] forCellWithReuseIdentifier:cellId];
    }
    return _contenView;
}
...
-(UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    THNCuXiaoCollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:cellId forIndexPath:indexPath];
