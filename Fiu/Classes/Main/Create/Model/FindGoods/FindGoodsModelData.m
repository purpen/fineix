...
@interface FindGoodsModelData ()
@end
@implementation FindGoodsModelData
...
-(instancetype)initWithDictionary:(NSDictionary *)dictionary
{
	...
	if(dictionary[@"rows"] != nil && [dictionary[@"rows"] isKindOfClass:[NSArray class]]){
		...
		for(NSDictionary * rowsDictionary in rowsDictionaries){
			FindGoodsModelRow * rowsItem = [[FindGoodsModelRow alloc] initWithDictionary:rowsDictionary];
