...
- (void)networkSearchGoods:(NSString *)keyword {
    [SVProgressHUD show];
    self.searchRequest = [FBAPI getWithUrlString:URLSearchGoods requestDictionary:@{@"t":@"7", @"q":keyword,@"evt":@"content", @"page":@(self.searchCurrentpageNum + 1), @"size":@"8"} delegate:self];
