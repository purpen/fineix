...
@interface FiuSceneInfoUserInfo ()
@end
@implementation FiuSceneInfoUserInfo
...
-(instancetype)initWithDictionary:(NSDictionary *)dictionary
{
	...
	if(![dictionary[@"counter"] isKindOfClass:[NSNull class]]){
		self.counter = [[FiuSceneInfoCounter alloc] initWithDictionary:dictionary[@"counter"]];
	}
